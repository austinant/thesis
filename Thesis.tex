...
= f(W). \]
\end{itemize}
%Both these points are straightforward consequences of the fact that $f|_W$ is a bijection $W \to f(W)$.
...
Set $f = \sum_{i=1}^n e_i$, $g=f+e_n$.%, and $C_\ell = \sum_{i=1}^\ell \{0,e_i\}$ for $\ell\in \{n-1,n\}$.
